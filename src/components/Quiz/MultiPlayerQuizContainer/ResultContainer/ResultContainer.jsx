...
const ResultContainer = ({ data, twoPlayer, score, endData }) => {
  const { quizCode, quizId, dailyQuizId } = useParams();
            ...
            <div className={classes.scoreContainer}>
              <div className="score">
                ...
                <div className="innerScore">
                  <span className="titleScore">
                    {twoPlayer ? data.titleScore : endData?.score ?? score}
                  </span>
                  ...
                  <div className={classes.bottomScore}>
                    {quizCode ? (
                      <Button
                        variant="contained"
                        onClick={() => {
                          history.push(`/${dailyQuizId ? "dailyQuiz" : "multiplayer"}/leaderboard/${quizId??dailyQuizId}`);
                        }}
                      >
                        Leaderboard
                      </Button>
                      ...
                      <>
                        <span className="titleScore">{endData.score}</span>
              ...
              {!twoPlayer && (
                <div className={classes.share}>
                  ...
                  <Button onClick={() => history.push(dailyQuizId ? "/dailyQuiz":"/multiplayer")}>
                    Menu
                  </Button>
                  <ShareDialog
                    data={{
                      url: `${window.location.origin}/#/${ dailyQuizId ? "dailyQuiz/play":"multiplayer/quiz"}/${quizId??dailyQuizId}`,
                    }}
